            ...
            cc.Class({
                ...
                onLoad: function () {
                    a.publicGameBool ? o.init() : finishLoad(),
                        ...
                        this.OffPos = null,
                        this.speedNum = 400 / (this.carmeraNode.getChildByName("MoveCamera").getComponent(cc.Camera).zoomRatio+0.5),
                        ...
                        this.playerNode.stopAllActions(),
                            this.playerNode.runAction(cc.sequence(cc.spawn(cc.moveTo(g, d), cc.callFunc(function () {
                                ...
                                1 == r ? (ToolsJs.removeNodeForArr(this.kedouArr, o.children[l]),
                                    this.tempArr = this.kedouArr,
                                    this.myFish = this.playerNode.getChildByName("kedou"),
                                    Math.abs(c - 1) > .05 && this.CameraChangeZoomRatio(c, 0.3)) : 2 == r ? (ToolsJs.removeNodeForArr(this.qingwaArr, o.children[l]),
                                        this.tempArr = this.qingwaArr,
                                        this.myFish = this.playerNode.getChildByName("qingwa"),
                                        Math.abs(c - 1) > .05 && this.CameraChangeZoomRatio(c, 0.3)) : 3 == r ? (ToolsJs.removeNodeForArr(this.haiguiArr, o.children[l]),
                                            this.tempArr = this.haiguiArr,
                                            this.myFish = this.playerNode.getChildByName("haigui"),
                                            Math.abs(c - .75) > .05 && this.CameraChangeZoomRatio(c, .3)) : 4 == r ? (ToolsJs.removeNodeForArr(this.xiaojinyuArr, o.children[l]),
                                                this.tempArr = this.xiaojinyuArr,
                                                this.myFish = this.playerNode.getChildByName("xiaojinyu"),
                                                Math.abs(c - .65) > .05 && this.CameraChangeZoomRatio(c, .3)) : 5 == r ? (ToolsJs.removeNodeForArr(this.jinliArr, o.children[l]),
                                                    this.tempArr = this.jinliArr,
                                                    this.myFish = this.playerNode.getChildByName("jinli"),
                                                    Math.abs(c - .55) > .05 && this.CameraChangeZoomRatio(c, .3)) : 6 == r ? (ToolsJs.removeNodeForArr(this.dianmanArr, o.children[l]),
                                                        this.tempArr = this.dianmanArr,
                                                        this.myFish = this.playerNode.getChildByName("dianman"),
                                                        Math.abs(c - .45) > .05 && this.CameraChangeZoomRatio(c, .3)) : 7 == r ? (ToolsJs.removeNodeForArr(this.shayuArr, o.children[l]),
                                                            this.tempArr = this.shayuArr,
                                                            this.myFish = this.playerNode.getChildByName("shayu"),
                                                            Math.abs(c - .4) > .05 && this.CameraChangeZoomRatio(c, .3)) : 8 == r && (ToolsJs.removeNodeForArr(this.jingyuArr, o.children[l]),
                                                                this.tempArr = this.shayuArr,
